...
public class FileUploadManager {
    ...
    private void initLogUpdatePath() {
        ...
        try {
            jo1.put("path", "/mnt/sdcard/cn.redcdn.hvs/main/log");
            ja.put(jo1);
            jo2.put("path", "/mnt/sdcard/cn.redcdn.hvs/main/crash");
            ja.put(jo2);
            jo3.put("path", "/mnt/sdcard/cn.redcdn.hvs/auth");
            ja.put(jo3);
            jo4.put("path", "/mnt/sdcard/cn.redcdn.hvs/dump");
            ja.put(jo4);
            jo6.put("path","/mnt/sdcard/cn.redcdn.hvs/sdkLog");
            ja.put(jo6);
            jo7.put("path","/mnt/sdcard/cn.redcdn.hvs/jmeetingsdk");
            ja.put(jo7);
            jo8.put("path","/mnt/sdcard/cn.redcdn.hvs/eventlogcat");
            ja.put(jo8);
            jo9.put("path","/mnt/sdcard/cn.redcdn.hvs/EventConnect");
            ja.put(jo9);
            jo10.put("path","/mnt/sdcard/cn.redcdn.hvs/InternalConnect");
            ja.put(jo10);
