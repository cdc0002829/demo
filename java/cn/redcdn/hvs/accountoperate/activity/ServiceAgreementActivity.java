        ...
        public void handleMessage(Message msg) {
            if (msg.what == TIMEOUT_ERROR) {
                ...
                if (servicewebView.getProgress() < 100) {
                    ...
                    CustomToast.show(ServiceAgreementActivity.this, " 网络不给力 ", Toast.LENGTH_LONG);
    ...
    protected void init() {
        ...
        servicewebView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                ServiceAgreementActivity.this.showLoadingView("加载中...", new DialogInterface.OnCancelListener() {
                    @Override
                    public void onCancel(DialogInterface dialog) {
                        dialog.dismiss();
                        CustomToast.show(ServiceAgreementActivity.this,
                                "加载取消", Toast.LENGTH_LONG);
                    }
                });
            ...
            public void onReceivedError(WebView view, int errorCode,
                ...
                CustomToast.show(ServiceAgreementActivity.this, "请检查网络是否已连接 ", Toast.LENGTH_LONG);
            }
