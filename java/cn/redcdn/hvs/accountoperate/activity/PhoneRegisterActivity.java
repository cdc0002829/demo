...
public class PhoneRegisterActivity extends cn.redcdn.hvs.base.BaseActivity {
    ...
    private void execNext() {
        ...
        if (!inValidNum(numEditText.getText().toString())) {
            CustomToast.show(PhoneRegisterActivity.this, "手机号格式不正确",
                    Toast.LENGTH_LONG);
            return;
        }
        if (pwdEidtText.getText().toString().length() < 6) {
            CustomToast.show(PhoneRegisterActivity.this, "密码格式不正确",
                    Toast.LENGTH_LONG);
            return;
        }
        PhoneRegisterActivity.this.showLoadingView("注册中",new OnCancelListener() {
        ...
        gnl = new GetNubeNumberList() {
                ...
                ra = new RegisterAccount() {
                    ...
                    protected void onSuccess(ResponseEmpty responseContent) {
                        ...
                        CustomToast.show(PhoneRegisterActivity.this,
                                "系统向该手机号下发短信，请注意查收！", Toast.LENGTH_LONG);
                        Intent i = new Intent();
                    ...
                    protected void onFail(int statusCode, String statusInfo) {
                        ...
                        if (statusCode == -432) {
                            ...
                            CustomToast.show(PhoneRegisterActivity.this,
                                    "该手机号已注册，请重新输入", Toast.LENGTH_LONG);
                            return;
                        }
                        if (statusCode == -452) {
                            CustomToast.show(PhoneRegisterActivity.this,
                        ...
                        // 其他状态还不确定
                        CustomToast.show(PhoneRegisterActivity.this, "注册失败="
            ...
            protected void onFail(int statusCode, String statusInfo) {
                ...
                CustomToast.show(PhoneRegisterActivity.this, "注册失败="+statusCode,
                        Toast.LENGTH_LONG);
            }
        };
