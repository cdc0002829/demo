...
public class MedicalApproveActivity extends cn.redcdn.hvs.base.BaseActivity {
    ...
    private void submitUserInfo() {
        final MDSAppSubmitUserInf submitUserInf = new MDSAppSubmitUserInf() {
            ...
            protected void onFail(int statusCode, String statusInfo) {
                ...
                if (statusCode == MDS_TOKEN_DISABLE) {
                    ...
                    CustomToast.show(MedicalApproveActivity.this, "您的帐号正在审核中，请重新登录", Toast.LENGTH_LONG);
        ...
        MedicalApproveActivity.this.showLoadingView("提交审核资料中", new DialogInterface.OnCancelListener() {
        ...
        int workUnitType = 0;
        if (!AccountManager.getInstance(MedicalApplication.context).getAccountInfo().getWorkUnitType().equals("")) {
        ...
        if (certPreUrl == null || certPreUrl.length() == 0) {
            CustomToast.show(MedicalApproveActivity.this, "请上传手持工牌照或名片", CustomToast.LENGTH_LONG);
            removeLoadingView();
            return;
        }
    ...
    private void showDialog() {
        ...
        cid.setCameraClickListener(new CameraImageDialog.CameraClickListener() {
            ...
            public void clickListener() {
                ...
                if (!result){
                    CustomToast.show(MedicalApproveActivity.this, "请开启相机权限", CustomToast.LENGTH_SHORT);
                }
                camera();
            }
        });
    ...
    private void upLoad(String path) {
        UploadManager.UploadImageListener listener = new UploadManager.UploadImageListener() {
            ...
            public void onFailed(int statusCode, String msg) {
                ...
                if (HttpErrorCode.checkNetworkError(statusCode)) {
                    CustomToast.show(MedicalApproveActivity.this, "网络不给力，请检查网络！",
                            Toast.LENGTH_LONG);
                    return;
                }
        ...
        MedicalApproveActivity.this.showLoadingView("上传认证照片中", new DialogInterface.OnCancelListener() {
