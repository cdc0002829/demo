...
public class AccountManager {
    ...
    public void tokenAuthFail(int errorCode) {
        ...
        logout();
        CustomToast.show(mContext, "token失效，请重新登录",Toast.LENGTH_LONG);
    }
    ...
    private void onLoginSuccess() {
        ...
        authAgent = null;
        loginForMDS = null;
        if(AppP2PAgentManager.p2pAgentMgr != null){
            CustomLog.d(TAG,"登录成功，p2p实例不为空，重新登录p2p");
            AppP2PAgentManager.p2pAgentMgr.backgroundLogin();
        }
    }
