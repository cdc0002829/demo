    ...
    private void changePwd() {
        ...
        if (pwdEditString != null && !pwdEditString.equalsIgnoreCase("")) {
            if (pwdEditString.length() < 6)
                CustomToast.show(ChangePwdActivity.this, "密码不能少于六位数字",
                        Toast.LENGTH_LONG);
            else {
                final ChangePassword cp = new ChangePassword() {
                    ...
                    protected void onSuccess(UserInfo responseContent) {
                        ...
                        CustomToast.show(ChangePwdActivity.this, "修改密码成功",
                                Toast.LENGTH_LONG);
...
//                                            pwdEdit.setText("");
                        ...
                        ChangePwdActivity.this.showLoadingView("登录中", new DialogInterface.OnCancelListener() {
                            ...
                            public void onCancel(DialogInterface dialog) {
                                ...
                                CustomToast.show(ChangePwdActivity.this, R.string.login_cancel,
                                        Toast.LENGTH_LONG);
                    ...
                    protected void onFail(int statusCode, String statusInfo) {
                        ...
                        CustomToast.show(ChangePwdActivity.this, "修改密码失败="
                                + statusCode, Toast.LENGTH_LONG);

                    }
                };
                ChangePwdActivity.this.showLoadingView("提交中",
            ...
            CustomToast.show(ChangePwdActivity.this, "密码不能为空",
                    Toast.LENGTH_LONG);
        }
    }
