...
//          TODO      MeetingManager.getInstance().setAccountName(newmeetingname);
            ...
            protected void onFail(int statusCode, String statusInfo) {
                ...
                if (HttpErrorCode.checkNetworkError(statusCode)) {
                    CustomToast.show(ChangeMeetingNameActivity.this, "网络不给力，请检查网络！",
                            Toast.LENGTH_LONG);
                    return;
                }
                ...
                CustomToast.show(ChangeMeetingNameActivity.this,
                        "参会名称修改失败", Toast.LENGTH_LONG);
            }
        };
        ChangeMeetingNameActivity.this.showLoadingView("修改中", new DialogInterface.OnCancelListener() {
