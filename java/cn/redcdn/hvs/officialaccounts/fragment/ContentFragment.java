...
public class ContentFragment extends BaseFragment {
    ...
    protected View createView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            CustomLog.e(TAG, "officialName" + officialName);
    ...
    private void findDate(final boolean isAppend) {
        ...
        mMDdsGetArticlesByOffAcc = new MDSAppGetArticlesByOffAcc() {
            ...
            protected void onSuccess(MDSFocusPageInfo responseContent) {
                ...
                for (int i = 0; i < countSize; i++) {
                    ...
                    CustomLog.e(TAG, "offaccName" + responseContent.getFocusList().get(i).getOffaccName());
                }
        ...
        mMDdsGetArticlesByOffAcc.appGetArticlesByOffAcc(AccountManager.getInstance(mContext).getToken(), officialAccountId, requestPageNumber, requestCount);
    }
