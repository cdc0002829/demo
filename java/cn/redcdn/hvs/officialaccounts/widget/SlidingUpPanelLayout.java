...
public class SlidingUpPanelLayout extends ViewGroup {
        ...
        if (mDragView != null) {
            ...
            mDragView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    Log.i("SlidingUpPanelLayout", "SlidingUpPanelLayout类_onClick方法：");
                    ...
                    if (mSlideState != PanelState.EXPANDED && mSlideState != PanelState.ANCHORED) {
                        ...
                        setPanelState(PanelState.COLLAPSED);// 关闭“展开列表”
                        setPanelState(PanelState.HIDDEN); // 隐藏“展开列表”的标题
                    }
                }
            });
            ;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        if (mIsScrollableViewHandlingTouch || !isTouchEnabled()) {
            Log.i("SlidingUpPanelLayout", "2222222222222222");
            mDragHelper.abort();
            return false;
        }
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN: {
                ...
                mInitialMotionX = x;
                mInitialMotionY = y;
                Log.i("SlidingUpPanelLayout--", mInitialMotionY - y + " --");
//                if (!isViewUnder(mDragView, (int) x, (int) y)) {
                Log.i("SlidingUpPanelLayout", "+++++++++++");
                mDragHelper.cancel();
...
//                break;
        ...
        Log.i("SlidingUpPanelLayout", "111111111111111");
    ...
    private boolean isViewUnder(View view, int x, int y) {
        ...
        // viewLocation[1] 头部top位置，view.getHeight() 头部bottom位置
