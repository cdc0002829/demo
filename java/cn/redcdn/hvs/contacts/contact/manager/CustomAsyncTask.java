...
//                            PROFESSIONAL, OFFICETEL, SAVE_TO_CONTACTS_TIME
                        ...
                        mc.addRow(new Object[]{CommonUtil.getUUID(), ContactManager.groupChat, ContactManager.groupChat, "", 0,
                                0, "", "", "0", "",
                                1, 1, 0, "", "",
                                "", "", "", "", "",
                                "", 0, 1, "", "",
                                "", "", ""});
                        mc.addRow(new Object[]{CommonUtil.getUUID(), ContactManager.publicNumber, ContactManager.publicNumber, "", 0,
                                0, "", "", "1", "",
                                1, 1, 0, "", "",
                                "", "", "", "", "",
                                "", 0, 1, "", "",
                                "", "", ""});
                        mm.addRow(new Object[]{CommonUtil.getUUID(), ContactManager.customerServiceName, ContactManager.customerServiceName, "#", 0,
...
//                    Cursor[] a = new Cursor[]{mc, mm, m2, m1};
                ...
                case OPERATE_DELETE: // 删除 TODO
                    ...
                    CustomLog.e(TAG, "OPERATE_DELETE result " + result.status);
                    break;
