...
//                showToast("接口调用失败"+"("+code+")");
                ...
                //调用接口成功
                setGroupInterfaceBean(code,new GroupInterfaceBean(-1, "", strGroupName, groupListener));
            }
        }
...
//                showToast("接口调用失败"+"("+code+")");
                ...
                setGroupInterfaceBean(code,new GroupInterfaceBean(-1, strGroupID, strGroupName, groupListener));
            }
...
//                showToast("接口调用失败"+"("+code+")");
                ...
                setGroupInterfaceBean(code,new GroupInterfaceBean(-1, strGroupID, "", groupListener));
            }
        }
...
//                showToast("接口调用失败"+"("+code+")");
                ...
                setGroupInterfaceBean(code,new GroupInterfaceBean(type, strGroupID, "", groupListener));
            }
        }
...
//                showToast("接口调用失败"+"("+code+")");
    ...
    public  int groupQueryDetailBackgroud(String strGroupID, MessageGroupEventParse eventParse){
        ...
        CustomLog.d(TAG, "groupQueryDetailBackgroud return Code = " + code);
        CustomLog.d(TAG,"groupQueryDetailBackgroud return Code = " + code);
        return code;
    }
