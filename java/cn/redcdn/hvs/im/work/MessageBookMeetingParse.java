...
public class MessageBookMeetingParse extends MessageBaseParse {

    private PrivateMessage msg = null;
    private int type = -1;
    private ExtInfo extInfo = null;

    public MessageBookMeetingParse(PrivateMessage msg){
        this.msg = msg;
        this.type = FileTaskManager.NOTICE_TYPE_MEETING_BOOK;
    }
    ...
    public boolean parseMessage(){
        ...
        switch(verInt){
            ...
            default:{
                ...
                String body = noticesDao.createRecMeetingBookMsgBody(msg.extendedInfo);
                ...
                CustomLog.d("MessageBookMeetingParse","V1.00消息版本，插入本地文字 uuid="+uuid);
