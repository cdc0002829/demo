...
//		mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            }else if("视频会诊".equals(string[position])){
                if (nubeNumber.length() > 12
            ...
            }else if ("拍摄".equals(string[position])) {
                if (nubeNumber.length() > 12
                    || ButelOvell.hasSendVedioAbility(ButelOvell
                    .getNubeOvell(nubeNumber))) {
                    imageView
...
//                        .setImageResource(R.drawable.select_vedio_disabled);
            ...
            } else if("我的收藏".equals(string[position])){
                if (nubeNumber.length() > 12
                        || ButelOvell.hasSendVedioAbility(ButelOvell
                        .getNubeOvell(nubeNumber))) {
                    imageView
...
//                }
//            }
            else if ("小视频".equals(string[position])) {
                if (nubeNumber.length() > 12
                        || ButelOvell.hasSendCardAbility(ButelOvell
                        .getNubeOvell(nubeNumber))) {
                    imageView
            ...
            } else if ("名片".equals(string[position])) {
                if (nubeNumber.length() > 12
                    || ButelOvell.hasSendCardAbility(ButelOvell
                    .getNubeOvell(nubeNumber))) {
                    imageView
