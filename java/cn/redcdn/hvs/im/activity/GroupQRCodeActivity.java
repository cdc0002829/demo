...
public class GroupQRCodeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initWidget();
        initData();
        loadQRCode(AccountManager.getInstance(this).getToken(), mGroupId);
        loadGroupInfo();
    ...
    private void loadQRCode(String token, String groupID) {
        final MDSAppGetGroupQrCodeBytes getbyte = new MDSAppGetGroupQrCodeBytes(){
            ...
            protected void onFail(int statusCode, String statusInfo) {
                CustomToast.show(getApplicationContext(), "加载二维码失败", 1);
                removeLoadingView();
    ...
    private void setQRCodeValidTime() {
        ...
        //显示群二维码有效期
        validTimeTxt.setText("该二维码7天内 (" + validTime + ") " + "有效，" +
            "重新进入将更新");
    }
