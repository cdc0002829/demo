...
public class ModifyActivity extends BaseActivity {
    ...
    private void upDataNoteNameView(){
        ...
        mTextView.setText("最多"+mMaxLength+"个字符，可由中英文、数字和其它字符组成");
    ...
    private void upDataNickNameView(){
        initTopTitle("修改昵称",VALUE_OF_TYPE_MODIFY_NICK_NAME);
    ...
    private void upDataGroupNameView(){
        initTopTitle("群聊名称",VALUE_OF_TYPE_MODIFY_GROUP_NAME);
    ...
    private void upDataPWDView(){
        initTopTitle("修改密码",VALUE_OF_TYPE_MODIFY_PWD);
        mTextView.setVisibility(View.INVISIBLE);
        mEditText.setText("");
        mEditText.setHint("输入6位数字新密码");
