...
public class ShareLocalActivity extends BaseActivity {
    ...
    // 不同的转发入口标记，0表示消息页面的转发，1表示收藏页面的转发
...
//        contacts.pressableTextview.setVisibility(View.INVISIBLE);
        ...
        // if (TextUtils.isEmpty(ownNumber) || TextUtils.isEmpty(token)) {
        //     // 未登录时，不能分享
        //     Toast.makeText(this, getString(R.string.share_login_first),
        //         Toast.LENGTH_LONG).show();
        //     Intent i = new Intent();
        //     i.setClass(this, NetPhoneGuideActivity.class);
        //     startActivity(i);
        //
        //     finish();
        // }
        ...
        adapter.setShareCallBack(new ShareCursorAdapter.ShareCallBack() {
            ...
            public void sharePic(final String threadId, final String receiver,
                    ...
                    if (getShareType() == CHOOSER_TYPE_IMAGE) {
                        ...
                        if (!ButelOvell.hasSendPicturesAbility(ovell)) {
                            ...
                            Toast.makeText(ShareLocalActivity.this,
                                "该设备不能分享图片", Toast.LENGTH_SHORT).show();
                            return;
                        }
                        ...
                        if (!ButelOvell.hasSendVedioAbility(ovell)) {
                            Toast.makeText(ShareLocalActivity.this,
                                "该设备不能分享视频", Toast.LENGTH_SHORT).show();
                            return;
                        }
                    } else {
                        // 同时包含 图片、视频
                        ...
                        if (!ButelOvell.hasSendPicturesAbility(ovell)
                            && !ButelOvell.hasSendVedioAbility(ovell)) {
                            Toast.makeText(ShareLocalActivity.this,
                                "该设备不能分图片和视频", Toast.LENGTH_SHORT).show();
                            return;
                        }
                ...
                View selfView = inflater.inflate(
                    R.layout.share_confirm_dialog_view, null);

                // 自定义dialog view
                initSelfControl(selfView, threadId, receiver, showName,
                    headUrl, threadType);

                CommonDialog conDlg = new CommonDialog(ShareLocalActivity.this,
    ...
    private void forwardMsg(String receiver) {
        if(shareFlag ==1 ){
        ...
        Toast.makeText(this, getString(R.string.toast_sent), Toast.LENGTH_SHORT)
            .show();
        // 转发，回到当前聊天页面--2015-9-9
        finish();
    }
    ...
    private void initSelfControl(View selfView, String threadId,
        ...
        if (threadType == ThreadsTable.TYPE_GROUP_CHAT) {
            ...
            numView.setText(groupMemberSize + "人");
                    ...
                    if (selRes != null) {
                        ...
                        if (receiverNameMap.size() > 1) {
                            ...
                            if (!mIsForward) {
                                ...
                                forwardMsg(receiverNumberLst.get(0));
                            }
    ...
    private void singleShare(Bundle bundle) {
        ...
        if (bundle.containsKey(Intent.EXTRA_STREAM)) {
            ...
            Toast.makeText(this, "信息不全，无法分享", Toast.LENGTH_SHORT).show();
