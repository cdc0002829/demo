...
//                }
    ...
    private void updateView(){
        ...
        tvGroupMemberCount.setText("(共" + memberDateList.size() + "人)");
        Glide.with(this)
    ...
    private void addGroupRequest(){
        showLoadingView("加入群组中...", new DialogInterface.OnCancelListener() {
            @Override
...
//                CustomToast.show(mContext,"加入群组失败，请重试",1);
    ...
    public void onResult(String _interfaceName, boolean isSuccess, String result) {
        ...
        if(isSuccess){
            ...
            CustomToast.show(GroupAddActivity.this,"查询群信息失败,请重试",1);
        }
    }
